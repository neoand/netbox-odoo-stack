    ...
    >
      <div class="flex min-h-0 flex-1 flex-col bg-white border-r border-gray-200">
        ...
        <div class="flex h-16 flex-shrink-0 items-center px-4 border-b border-gray-200">
          ...
          <span class="ml-2 text-sm text-gray-500">Admin Portal</span>
        </div>
          ...
          <ul class="space-y-1 px-2">
            ...
            <li>
              <NuxtLink
                to="/tenants"
                class="sidebar-nav-link"
                :class="{ 'active': $route.path.startsWith('/tenants') }"
              >
                <UIcon name="i-heroicons-building-office" class="w-5 h-5 mr-3" />
                Tenants
              </NuxtLink>
            </li>
            ...
            <li>
              ...
              >
                <UIcon name="i-heroicons-receipt-percent" class="w-5 h-5 mr-3" />
                Invoices
              </NuxtLink>
            </li>
