<template>
  <div>
      ...
      <UCard>
        <div class="flex items-center justify-between mb-4">
          ...
          <div class="p-3 bg-blue-100 rounded-full">
            <UIcon name="i-heroicons-bolt" class="w-8 h-8 text-blue-600" />
          </div>
        </div>
        <div class="space-y-2">
      ...
      <UCard>
        <div class="flex items-center justify-between mb-4">
          ...
          <div class="p-3 bg-green-100 rounded-full">
            <UIcon name="i-heroicons-computer-desktop" class="w-8 h-8 text-green-600" />
          </div>
        </div>
        <div class="space-y-2">
          <div class="flex justify-between text-sm">
    ...
    <!-- Usage warnings -->
    <div v-if="subscriptionStore.usageWarnings.length > 0" class="mb-8">
      <UAlert
    ...
    <UCard class="mt-8">
      <template #header>
        <h3 class="text-lg font-semibold text-gray-900">Usage by Resource</h3>
      </template>
      ...
      <div class="space-y-6">
        ...
        <div>
          <div class="flex items-center justify-between mb-3">
            <h4 class="text-sm font-medium text-gray-700">API Calls Breakdown</h4>
        ...
        <div>
          <div class="flex items-center justify-between mb-3">
            <h4 class="text-sm font-medium text-gray-700">Storage Breakdown</h4>
            <p class="text-sm text-gray-500">
