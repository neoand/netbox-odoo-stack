<template>
  <div>
    ...
    <UCard class="mb-8">
      ...
      <div v-if="billingStore.paymentMethods.length > 0" class="space-y-3">
        <div
        ...
        >
          <div class="flex items-center space-x-4">
            ...
            <div>
              ...
              <p v-if="method.exp_month && method.exp_year" class="text-xs text-gray-500">
      ...
      <div v-else class="text-center py-8">
        <UIcon name="i-heroicons-credit-card" class="w-12 h-12 text-gray-400 mx-auto" />
        <p class="text-sm text-gray-500 mt-4">No payment methods added</p>
        <UButton
          color="primary"
          class="mt-4"
          @click="showAddPaymentModal = true"
