    ...
    >
      <div class="flex min-h-0 flex-1 flex-col bg-white border-r border-gray-200">
        ...
        <div class="flex h-16 flex-shrink-0 items-center px-4 border-b border-gray-200">
          <div>
            <h1 class="text-xl font-bold text-gray-900">NEO_STACK</h1>
            <p class="text-xs text-gray-500">{{ authStore.currentTenant?.name }}</p>
          </div>
        </div>
        ...
        <nav class="flex-1 overflow-y-auto py-4">
          <ul class="space-y-1 px-2">
            ...
            <li>
              ...
              >
                <UIcon name="i-heroicons-chart-bar-square" class="w-5 h-5 mr-3" />
                Usage
              </NuxtLink>
            </li>
            ...
            <li>
              ...
              >
                <UIcon name="i-heroicons-squares-plus" class="w-5 h-5 mr-3" />
                Resources
              </NuxtLink>
            </li>
      ...
      <div class="sticky top-0 z-10 flex h-16 flex-shrink-0 bg-white border-b border-gray-200">
        ...
        <div class="flex flex-1 justify-between px-4">
          ...
          <div class="ml-4 flex items-center md:ml-6 space-x-4">
            <!-- Usage warnings -->
            <div v-if="subscriptionStore.usageWarnings.length > 0" class="flex items-center">
              <UIcon name="i-heroicons-exclamation-triangle" class="w-5 h-5 text-yellow-500 mr-1" />
